...
public class KitchenView {
    ...
    public void update(int number, int orderCount, boolean orderIsInspected, HashMap<OrderLine, Integer> order, KitchenViewController kitchenViewController) {
        countOrders.setText("Count of orders in waiting line: " + orderCount);
        Buttons.update(number, orderCount, orderIsInspected, order, kitchenViewController);
